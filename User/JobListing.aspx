<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="WebUngTuyenViecLamIT.User.JobListing" %>
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-Categories pb-25 mb-20">
                                    ...
                                    <div class="radiobuttoncontainer">
                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="radiobuttonlist" AutoPostBack="true"
                                            OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" RepeatLayout="Flow" mb-20>
                                            <asp:ListItem Value="0" Selected="True">Gần đây</asp:ListItem>
                                ...
                                <div class="mb-4">
                                    <asp:LinkButton ID="lbReset" runat="server" CssClass="btn btn-sm" Width="100%"
                                        OnClick="lbReset_Click">Làm Mới</asp:LinkButton>
                                </div>
                            </div>
                        </div>
