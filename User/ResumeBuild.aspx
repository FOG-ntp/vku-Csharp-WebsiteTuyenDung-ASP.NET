<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="ResumeBuild.aspx.cs" Inherits="WebUngTuyenViecLamIT.User.ResumeBuild" %>
    ...
    <section>
        <div class="contrainer pt-50 pd-50">
            <div class="row">
                ...
                <div class="col-12">
                    <h2 class="contact-title text-xl-center">Thông Tin Hồ Sơ</h2>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 ">
                             ...
                             <div class="col-md-6 col-sm-12 ">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="VD: 1 năm / Java" required></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtWork" runat="server" CssClass="form-control" placeholder="Mô tả thông tin công việc từng tham gia ..." required></asp:TextBox>
                                </div>
                            </div>
